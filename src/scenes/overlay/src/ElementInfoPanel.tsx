import {
        ...
        >
          <Grid item xs={1} sx={{ height: "auto", width: "100%", p: 0 }}>
            ...
            >
              ...
              <Typography variant="h6">{!selected ? "Selected elements" : selected.groupName}</Typography>
            </Box>
          </Grid>
  
          <Grid item xs={3}>
            <Box component="div" sx={{ height: "auto", p: 2 }}>
              <Typography variant="body2">Summary data of selected elements</Typography>
            </Box>
          </Grid>
  ...
  const columns: Column[] = [
    { id: "select", label: "Select", minWidth: 20, maxWidth: 25 },
    {
      id: "Material",
      label: "Material",
      minWidth: 20,
